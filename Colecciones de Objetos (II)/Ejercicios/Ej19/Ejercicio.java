...
//========================
   public class Ejercicio {
      public static void rellenar(String[] args, Collection c) {
      ...
      public static String nombre(Collection<Humano> c, int dni) {
      ...
      public static void main(String[] args) {
         Collection<Humano> c = new ArrayList<Humano>();
         rellenar(args,c);
         Scanner in = new Scanner(System.in);
         System.out.print("Introduce dni: ");
         int dniABuscar = in.nextInt();
         System.out.print("Nombre: "+ nombre(c,dniABuscar));
      }
   }